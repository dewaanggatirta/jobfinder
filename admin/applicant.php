...
<head>
    ...
    <style>
        ...
        .badge-status { padding: 5px 10px; border-radius: 4px; font-size: 0.85rem; }
    </style>
</head>
        ...
        <div class="sidebar">
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                    ...
                    <!-- MENU DROPDOWN (Sesuai Permintaan) -->
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="jobs.php" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i><p>Kelola Lowongan</p>
                                </a>
                            </li>
                            <!-- Menu Aktif Saat Ini -->
                            <li class="nav-item">
                                <a href="applicant.php" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i><p>Lihat Lamaran</p>
                                </a>
                            </li>
                            <li class="nav-item">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6"><h1>Kelola Lamaran Masuk</h1></div>
                </div>
            </div>
        </section>
                            ...
                            <tbody>
                                <?php if ($result && $result->num_rows > 0): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="applicant_detail.php?id=<?= $row['user_id'] ?>" class="text-info font-weight-bold">
                                                <?= htmlspecialchars($row['pelamar_name']) ?> <i class="fas fa-external-link-alt small ml-1"></i>
                                            </a>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            <a href="../uploads/<?= htmlspecialchars($row['cv_file']) ?>" target="_blank" class="btn btn-xs btn-outline-light">
                                        ...
                                        <td>
                                            <a href="applicant.php?delete_id=<?= $row['id'] ?>" class="btn btn-xs btn-danger" onclick="return confirm('Hapus data lamaran ini?')">
