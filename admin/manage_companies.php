                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <?php if($row['logo']): ?>
                                            <img src="../company/uploads/<?= htmlspecialchars($row['logo']) ?>"
                                                width="50">
                                            <?php else: ?>
                                        ...
                                        <td>
                                            <a href="manage_companies.php?delete_id=<?= $row['id'] ?>"
                                                class="btn btn-sm btn-danger"
                                                onclick="return confirm('Yakin hapus perusahaan ini? Semua lowongan mereka juga akan terhapus.')">
