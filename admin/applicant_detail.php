                            ...
                            <div class="card card-primary card-outline">
                                <div class="card-body box-profile">
                                    <div class="text-center">
                                        <div class="img-circle elevation-2 d-flex align-items-center justify-content-center bg-light mx-auto"
                                            style="width:100px; height:100px; font-size:3rem; color:#007bff;">
                                            <?= strtoupper(substr($user['name'], 0, 1)) ?>
                                        </div>
                                    </div>
                                    <h3 class="profile-username text-center mt-3"><?= htmlspecialchars($user['name']) ?>
                                    </h3>
                                    <p class="text-muted text-center">Pencari Kerja</p>
                                    <ul class="list-group list-group-unbordered mb-3">
                                        <li class="list-group-item bg-dark">
                                            <b>Email</b> <a
                                                class="float-right"><?= htmlspecialchars($user['email']) ?></a>
                                        </li>
                                        <li class="list-group-item bg-dark">
                                            <b>Bergabung</b> <a
                            ...
                            <div class="card">
                                <div class="card-header p-2">
                                    <ul class="nav nav-pills">
                                        <li class="nav-item"><a class="nav-link active" href="#history"
                                                data-toggle="tab">Riwayat Lamaran</a></li>
                                    </ul>
                                </div>
                                <div class="card-body">
                                    <div class="tab-content">
                                        <div class="active tab-pane" id="history">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="timeline-item border-0">
                                                        <span class="time"><i class="far fa-clock"></i>
                                                            <?= date('d M Y H:i', strtotime($h['applied_at'])) ?></span>
                                                        <h3 class="timeline-header"><a
                                                                href="#"><?= htmlspecialchars($h['title']) ?></a> di
                                                            <?= htmlspecialchars($h['company']) ?></h3>
                                                        <div class="timeline-body">
                                                            ...
                                                            ?>
                                                            <br>
                                                            <a href="../uploads/<?= htmlspecialchars($h['cv_file']) ?>"
                                                                target="_blank"
                                                                class="btn btn-xs btn-outline-info mt-2">Lihat CV yang
                                                                dikirim</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <?php else: ?>
                                            <p class="text-center text-muted">User ini belum pernah melamar pekerjaan.
                                            </p>
                                            <?php endif; ?>
                                        </div>
                                    </div>
